...
class ARTCMeetingView<T> extends StatefulWidget {
  ...
  @override
  State<ARTCMeetingView<T>> createState() => _ARTCMeetingViewState<T>();
}

class _ARTCMeetingViewState<T> extends State<ARTCMeetingView<T>> {
  ...
  @override
  void didUpdateWidget(covariant ARTCMeetingView<T> oldWidget) {
    controller.attach(
      config: config,
      frameBuilder: widget.frameBuilder,
      itemBackground: widget.itemBackground,
