...
abstract class SlideViewConfig {
  SlideViewConfig._();
...
class IndicatorConfig {
  ...
  final Color? indicatorColorSelected;

  /// Size of each indicator
  final double? indicatorSize;

  /// Space between every indicator
  final double? indicatorBetweenSpace;
  ...
  const IndicatorConfig({
    ...
    this.indicatorSize,
    this.indicatorBetweenSpace,
    this.indicatorAnimationType,
    this.indicator,
    this.indicatorSelected,
  })  : assert(indicatorSize == null || indicatorSize >= 0),
        assert(indicatorBetweenSpace == null || indicatorBetweenSpace >= 0);
}
