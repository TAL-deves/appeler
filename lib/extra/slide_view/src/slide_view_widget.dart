...
class IntroSliderState extends State<IntroSlider>
  ...
  late final IndicatorAnimationType typeIndicatorAnimation;
  ...
  void initState() {
    ...
    // Indicator
    isShowIndicator = widget.indicatorConfig?.indicatorVisible ?? true;
    colorIndicator = widget.indicatorConfig?.indicatorColor ?? Colors.black54;
    colorActiveIndicator =
        widget.indicatorConfig?.indicatorColorSelected ?? colorIndicator;
    sizeIndicator = widget.indicatorConfig?.indicatorSize ?? 8;
    spaceBetweenIndicator =
        widget.indicatorConfig?.indicatorBetweenSpace ?? sizeIndicator;
    typeIndicatorAnimation = widget.indicatorConfig?.indicatorAnimationType ??
        IndicatorAnimationType.sliding;
    indicatorWidget = widget.indicatorConfig?.indicator;
    activeIndicatorWidget = widget.indicatorConfig?.indicatorSelected;
    ...
    switch (typeIndicatorAnimation) {
      case IndicatorAnimationType.sliding:
        ...
        break;
      case IndicatorAnimationType.scaling:
        for (var i = 0; i < lengthSlide; i++) {
          if (i == 0) {
  ...
  bool isRTLLanguage(String language) {
    return SlideViewConfig.rtlLanguages.contains(language);
  }
            ...
            Flexible(
              child: isShowIndicator
                  ? Stack(
                      ...
                      children: <Widget>[
                        renderListIndicator(),
                        typeIndicatorAnimation == IndicatorAnimationType.sliding
