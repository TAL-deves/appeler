enum PrivacyContent {
  ...
  noticeOfAmendmentsOfTermsAndConditionsAndPrivacyPolicy(
    ...
    body:
        "Without giving you any warning or prior notification, we retain the right to change the terms and privacy policy whenever it is necessary. These terms and conditions will be regarded as accepted by you if you use this website in the future. Any modifications or amendments are to be accepted. You are strongly encouraged to regularly examine the terms of service as a result. You can immediately stop using this website and any related services if you disagree with any amendment, addition or adjustment to the terms.",
  );
