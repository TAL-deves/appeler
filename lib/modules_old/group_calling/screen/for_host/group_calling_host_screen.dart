...
import '../for_remote/group_calling_remote_screen.dart';
  ...
  void _makeGroupCall() {
    SchedulerBinding.instance.addPostFrameCallback((timeStamp) {
      AppSnackBar.showSuccessSnackBar(
          message: 'Starting group call, please wait!!');
    });
                  ...
                  _curUserConnected.get().then((value) {
                    ...
                    if (curMap != null) {
                      ...
                      if (!curList.contains(id)) {
                        curList.add(id);
                        _curUserConnected.set({'curList': curList});
                        setState(() {
